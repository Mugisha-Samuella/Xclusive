...
const Categories = () => {
  return (
    <div className="p-6 pt-[8rem] md:p-20 overflow-x-scroll md:overflow-x-clip">
      ...
      <div className=" flex flex-row overflow-x-scroll gap-2  pt-10">
        <button className="border-gray-300 rounded-md border-[0.5px] flex flex-col p-10 justify-center items-center md:hover:bg-red-500 ">
          <Image src={"/Assets/Icons/Phone.svg"} width={50} height={50} alt="Phone icon" />
          <h3>Phones</h3>
        </button>
        <button className="border-gray-300 rounded-md border-[0.5px] flex flex-col p-10 justify-center items-center">
          <Image src={"/Assets/Icons/Computer.svg"} width={50} height={50} alt="Computer icon" />
          <h3>Laptops</h3>
        </button>
        <button className="border-gray-300 rounded-md border-[0.5px] flex flex-col p-10 justify-center items-center">
          <Image src={"/Assets/Icons/SmartWatch.png"} width={50} height={50} alt="Smartwatch icon" />
          <h3>Watches</h3>
        </button>
        <button className="border-gray-300 rounded-md border-[0.5px] flex flex-col p-10 justify-center items-center">
          <Image src={"/Assets/Icons/Camera.svg"} width={50} height={50} alt="Camera icon" />
          <h3>Camera</h3>
        </button>
        <button className="border-gray-300 rounded-md border-[0.5px] flex flex-col p-10 justify-center items-center">
          <Image src={"/Assets/Icons/Headphone.svg"} width={50} height={50} alt="Headphone icon" />
          <h3>Headphones</h3>
        </button>
      </div>
    </div>
